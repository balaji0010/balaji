...
const projectData = [
  ...
  { id: 8, images: ["./Asus1.png","/asus/Asus2.png","asus/Asus21.png","asus/Asus3.png"],image: ["./Asus1.png"], title: "Asus ROG " },
  { id: 9, images: ["./net.png","./net2.png"],image: ["./net.png"], title: "Netflix Redesign" },
  { id: 10, images: ["./NEWS.png","news2.png",],image: ["./NEWS.png"], title: "New Feed Application" },
